    ...
    @push('js')
        <script text="type/javascript">
            document.addEventListener('livewire:load', function() {
                var data = jQuery.parseJSON(@this.data);
                console.log(data);

                Highcharts.chart('horasChart', {
                    chart: {
                        plotBackgroundColor: null,
                        plorBorderWidth: null,
                        plotShadow: false,
                        type: 'pie'
                    },
                    title: {
                        text: 'Reporte de Horas con más Reservas'
                    },
                    tooltip: {
                    ...
                    series: [{
                        name: 'Porcentaje de horas reservadas',
                        colorByPoint: true,
                        data: data
                    }]
                });
