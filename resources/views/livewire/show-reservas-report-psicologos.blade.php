    ...
    <script text="type/javascript">
        document.addEventListener('livewire:load', function() {
            ...
            Highcharts.chart('psicoReport', {
                ...
                title: {
                    text: 'Reporte de psicológos más solicitados'
                },
                tooltip: {
                    pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b><br>Atenciones: <b>{point.y}</b>'
                },
                accesibility: {
                    point: {
                        valueSuffix: '%'
