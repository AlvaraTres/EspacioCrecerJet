    ...
    <div class="mx-auto bg-white-200 w-full ml-3 mr-3">
        ...
        <div class="flex items-stretch flex-wrap bg-white-300 w-full px-4 py-2">
            ...
            <select
                ...
                id="searchPaciente" name="searchPsico" wire:model="searchPsico" @if (\Auth::user()->id_users_rol == 2) disabled @endif>
            ...
            <x-jet-danger-button wire:click="resetFilt()"
                class="ml-3 inline-flex items-center justify-center px-4 py-3 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-500 focus:outline-none focus:border-green-700 focus:ring focus:ring-green-200 active:bg-green-600 disabled:opacity-25 transition">
                Resetear Filtros
            </x-jet-danger-button>
            @if (\Auth::user()->id_users_rol == 2)
                </div>
