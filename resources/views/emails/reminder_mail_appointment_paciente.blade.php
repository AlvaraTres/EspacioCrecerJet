...
<head>
    ...
    <title>Correo Recordatorio Email</title>
    <style>
        h3 {
            color: rgb(5, 150, 105);
            text-align: center;
...
<body>
    ...
    <div class="margened text-just">
        <h4>Te recordamos que tienes una cita con tu psicólogo el día
            {{ \Carbon\Carbon::parse($reserva[0]['fecha_hora_reserva'])->format('d-m-Y') }}&nbsp; a las
            {{ \Carbon\Carbon::parse($reserva[0]['fecha_hora_reserva'])->format('H:i') }}&nbsp;horas.</h4>
    </div>
