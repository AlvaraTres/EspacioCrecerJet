            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="min-h-screen flex flex-col sm:justify-center items-center pb-20 sm:pt-0"
                    ...
                    <div class="bg-green-500 sm:max-w-md shadow-md w-full overflow-hidden sm:rounded-lg">
                        <p class="font-bold text-white text-center mt-2 text-lg h-2">Trabaja con nosotros</p>
                        <div
                            class="w-full bg-gray-50 sm:max-w-md mt-6 px-6 py-4 shadow-md overflow-hidden sm:rounded-b-lg">
                            <p class="text-center">Si eres psicólogo, y quieres ser parte de la familia de Espacio Crecer, solo envianos tu CV a</p> <p class="underline text-center">espaciocrecer@gmail.com</p><p class="text-center"> y pronto nos contactaremos contigo.</p>
                        </div>
                    </div>
